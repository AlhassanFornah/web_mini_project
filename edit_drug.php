...
if (!isset($_SESSION['loggedIn'])) {
    ...
    if (isset($_POST["updateMedicine"])) {
        ...
        //Pickup variables what ever the user enter ino the html for
...
<div class="container">
    <div class="row mt-4">
        <div class="col-md-8 offset-md-2">
            <h3 class="display-5 my-1">Edit and Update Medicine</h3>
            <?php
            if (!empty($row)) {
                echo '
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="dosage_quantity" id="dosage_quantity" required class="form-control" min="1" max="250" value="' . $row["dosage_quantity"] . '">
                    </div>
                    <div class="form-group">
